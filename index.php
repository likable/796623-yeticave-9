        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $stuff_item["url"]; ?>" width="350" height="260" alt="<?= $stuff_item["title"]; ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $stuff_item["cat"]; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $stuff_item["title"]; ?></a></h3>
